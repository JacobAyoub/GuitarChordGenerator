...
"""
Model training and testing code below.
def main():
...
WINDOW_SEC = 1     # predict every 1 seconds
HOP_SEC = 1
...
audio_file = client.files.upload(file="p.mp3") #Upload the audio file to Gemini and get a reference ID for it
